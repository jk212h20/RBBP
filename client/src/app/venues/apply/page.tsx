  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-black">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        {/* Back Link */}
        <Link href="/venues" className="text-green-400 hover:text-green-300 mb-6 inline-block">
          ← Back to Venues
        </Link>
        ...
        {/* Application Form */}
        {!success && (
          <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-sm rounded-xl border border-green-600/30 p-6 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-green-600/30 rounded-lg px-4 py-2 text-white placeholder-green-300/40 focus:outline-none focus:border-green-500"
              ...
              <hr className="border-green-600/30" />
            ...
            <button
              type="submit"
              disabled={submitting}
              className="mt-6 w-full bg-green-600 hover:bg-green-700 disabled:bg-green-600/50 text-white font-bold py-3 rounded-lg transition"
            >
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl border border-green-600/30 p-6">
          ...
          {loadingApps ? (
            ...
            <p className="text-green-300/60 text-sm">You haven&apos;t submitted any applications yet.</p>
          ) : (
            <div className="space-y-3">
              {myApplications.map((app) => (
                <div
                  key={app.id}
                  className="bg-white/5 rounded-lg p-4 border border-green-600/20"
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="text-white font-semibold">{app.name}</h3>
                      <p className="text-green-200 text-sm">📍 {app.address}</p>
