...
export const createEventSchema = z.object({
  ...
  buyInSats: z.number().int().min(0).optional().nullable(),
  prepayDiscountSats: z.number().int().min(0).optional().default(0),
  prepayDiscountHours: z.number().int().min(0).max(720).optional().default(3),
...
export const updateEventSchema = z.object({
  ...
  buyInSats: z.number().int().min(0).optional().nullable(),
  prepayDiscountSats: z.number().int().min(0).optional().nullable(),
  prepayDiscountHours: z.number().int().min(0).max(720).optional(),
